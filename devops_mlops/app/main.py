...
app = FastAPI(
    title="Fetal Heath API", 
    openapi_tags=[
        {
            "name": "Health",
            "description": "Get api helth"
        },
        {
            "name": "Prediction",
...
def load_model():
    print('reading model...')
    MLFLOW_TRACKING_URI = 'https://dagshub.com/valdecisousa/my-first-repo.mlflow'
    MLFLOW_TRACKING_USERNAME = 'valdecisousa'
    MLFLOW_TRACKING_PASSWORD = '930d26db2f9d17d74d0f1ac1e5e81b1758bb341e'
...
# Mudei o nome de 'predict' para 'fetal_predict' para não dar conflito com o seu modelo
@app.post(path='/predict', tags=['Prediction'])
def fetal_predict(request : FetalHealthData):
    global loaded_model
